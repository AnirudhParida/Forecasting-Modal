...
app = FastAPI(
    title="Forecasting & Driver Interdependency API",
    description=(
...
async def root():
    ...
    return {
        "service": "Forecasting & Driver Interdependency API",
        "status": "online",
        "version": "1.0.0",
        "documentation": "/docs",
        "endpoints": {
            ...
            "host_prediction": "/api/v1/host-prediction?host_name=JPRUPIWEBCRP02&prediction_duration=30d",
        },
    }
